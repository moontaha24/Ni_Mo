                    ...
                    <div class="panel-body">
                        <form action="" name="form1" method="post">
                            ...
                            <div class="text-center">
                                <button type="submit" name="submit1" class="btn loginbtn btn-block" style="background-color: #6D7AD2; color: #fff; padding: 8px; font-size:18px">Register</button><br>
                                <a href="login.php" class="btn btn-block" style="background-color: #fff; color: #6D7AD2; padding: 8px ; font-size:18px; border-color:#6D7AD2; ">Go To Login Page</a>
                            </div>
